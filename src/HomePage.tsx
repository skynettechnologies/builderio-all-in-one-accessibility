...
const aioaicontype1 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-1.svg'
const aioaicontype2 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-2.svg'
const aioaicontype3 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-3.svg'
const aioaicontype4 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-4.svg'
const aioaicontype5 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-5.svg'
const aioaicontype6 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-6.svg'
const aioaicontype7 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-7.svg'
const aioaicontype8 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-8.svg'
const aioaicontype9 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-9.svg'
const aioaicontype10 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-10.svg'
const aioaicontype11 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-11.svg'
const aioaicontype12 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-12.svg'
const aioaicontype13 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-13.svg'
const aioaicontype14 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-14.svg'
const aioaicontype15 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-15.svg'
const aioaicontype16 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-16.svg'
const aioaicontype17 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-17.svg'
const aioaicontype18 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-18.svg'
const aioaicontype19 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-19.svg'
const aioaicontype20 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-20.svg'
const aioaicontype21 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-21.svg'
const aioaicontype22 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-22.svg'
const aioaicontype23 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-23.svg'
const aioaicontype24 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-24.svg'
const aioaicontype25 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-25.svg'
const aioaicontype26 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-26.svg'
const aioaicontype27 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-27.svg'
const aioaicontype28 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-28.svg'
const aioaicontype29 = 'https://builderio.skynettechnologies.us/assets/images/aioa-icon-type-29.svg'
const allinoneaccessibilitylogo =
  'https://builderio.skynettechnologies.us/assets/images/all-in-one-accessibility-logo.svg'
...
const HomePage: FC = () => {
  ...
  const [isSizeSwitcherEnabled, setSizeSwitcherEnabled] = useState<boolean>(false)
  ...
  const saveData = (data: {
    ...
    const widget_icon_size_custom =
      (document.getElementById('widget_icon_size_custom') as HTMLInputElement)?.value || ''
    const custom_position_x_value =
      (document.getElementById('custom_position_x_value') as HTMLInputElement)?.value || ''
    const custom_position_y_value =
      (document.getElementById('custom_position_y_value') as HTMLInputElement)?.value || ''
    const custom_position_left_right =
      (document.getElementById('custom_position_left_right') as HTMLInputElement)?.value || ''
    const custom_position_top_bottom =
      (document.getElementById('custom_position_top_bottom') as HTMLInputElement)?.value || ''
        ...
        if (Object.keys(response.Data).length !== 0) {
          ...
          setWidgetSettings({
            ...
            custom_position_left_right:
              parseInt(response.Data.widget_position_left) > 0 ? 'To the left' : 'To the right',
            custom_position_top_bottom:
              parseInt(response.Data.widget_position_bottom) > 0 ? 'To the bottom' : 'To the top',
          })
  ...
  function fetchApiData(website_name: string): void {
    ...
    const apiUrl: string = 'https://ada.skynettechnologies.us/api/get-autologin-link'
  ...
  return (
    <>
      ...
      <title>All In One Accessibility Builder.io Plugin</title>
      <meta name="description" content="Builder.io Plugin" />
      {/* <style>
      ...
      <link
        rel="stylesheet"
        type="text/css"
        href="https://builderio.skynettechnologies.us/assets/css/style.css"
      />
