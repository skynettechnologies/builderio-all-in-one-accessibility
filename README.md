...
```sh
npm install builderio-all-in-one-accessibility
```

## Setup & Usage

Go to the **Plugins** section, select **Advanced Configration**, add the following in **Add Plugin** option,

```sh
skynettechnologies/builderio-all-in-one-accessibility
```
